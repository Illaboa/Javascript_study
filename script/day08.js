//조건문 if
//비교연산자에 의해 출력된 논리데이터의 참(true) 거짓(fales)에 따라 다른 결과값을 보여주는 조건문
//if(조건식){조건 결과가 참 일 때 실행결과} //기본문법
//1. 사용자가 입력한 숫자가 짝수면 '짝수입니다.'결과 출력
/* const num1 = Number(window.prompt('1~99 사이 숫자를 입력하세요'))
if(num1%2==0){
    window.alert('짝수입니다!')
} */
//2. 하루 걸음 수를 입력받고 만보 이상일 경우 '목표달성'출력
/* const walkAmount = Number(window.prompt('하루 걸음 수는?'))
if(walkAmount>=10000){
    window.alert('목표달성')
} */
//-----------------------------------------
//거짓일 때 조건문
//if(조건식){조건식이 참 일 떄 실행문}else{조건식이 거짓일때 실행되는 실행문}
//관리자 아이디 :admit
...
console.log(a>10) //fales
//비교 논리연산 비교
console.log(a===10 && a>=10) //true && true = true
console.log(a!==10 && a===10) //fales && true = fales
console.log(a!==10 || a===10) //false || true = rtre
